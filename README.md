...
## To run the program do the following :
  - Make sure u have mysql installed with the user `root` and password `root` with dba perms. (if not then ask chat gpt to make one)
  ...
  - after this run the api and enjoy.
